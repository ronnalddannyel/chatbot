...
@endif
                <div class="row">
                    {{-- text danger subscription --}}
                     <h5 class="nav-link text-{{Auth::user()->is_expired_subscription ? 'danger' : 'success'}}  mt-1 hide-sidebar-toggle-button">Conta : {{Auth::user()->expired_subscription}}</h5>
                            ...
                            <div class="card-body">
                                <div class="widget-stats-container d-flex">
                                    <div class="widget-stats-icon widget-stats-icon-primary">
                                        <i class="material-icons-outlined">contatos</i>
                                    </div>
                                    <div class="widget-stats-content flex-fill">
                                        <span class="widget-stats-title">Todos os Contatos</span>
                            ...
                            <div class="card-body">
                                <div class="widget-stats-container d-flex">
                                    <div class="widget-stats-icon widget-stats-icon-warning">
                                        <i class="material-icons-outlined">mensagem</i>
                                    </div>
                                    <div class="widget-stats-content flex-fill">
                                        <span class="widget-stats-title">Envios de Mensagens</span>
    
                                        <span class="widget-stats-info">{{Auth::user()->blasts()->where(['status' => 'success'])->count()}} Com Sucesso</span>
                                        <span class="widget-stats-info">{{Auth::user()->blasts()->where(['status' => 'failed'])->count()}} Falhas</span>
                                    </div>
                            ...
                            <div class="card-body">
                                <div class="widget-stats-container d-flex">
                                    <div class="widget-stats-icon widget-stats-icon-danger">
                                        <i class="material-icons-outlined">agendadas</i>
                                    </div>
                                    <div class="widget-stats-content flex-fill">
                        ...
                        <div class="card">
                            <div class="card-body">
                                <div class="d-flex gap-4">
                                    ...
                                    <h5 class="">Lista de Números Whatsapp </h5><span class="text-warning text-sm">*Você tem o limite de {{$limit_device}} aparelhos</span>
                                </div>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLabel">Add Whatsapp</h5>
                ...
                <div class="modal-body">
                    <form action="{{route('addDevice')}}" method="POST">
                        ...
                        <p class="text-small text-danger">*Use o código do país ( com + )</p>
