        ...
        <div class="content-wrapper">
            <div class="container-fluid">
                <div class="row">
                           ...
                           {{-- make form sender,tag  --}}
                            <form  id="form" method="POST">
                                ...
                                <div class="row">
                                    ...
                                    <input type="text" class="form-control" id="name" name="name" placeholder="Campanha 1">
                                </div>
                                    </div>
                                    <div class="col-md-6">
                                         <div class="form-group">
                                    <label for="tag">N.° Whatsapp</label>
                    ...
                    <label for="inputEmail4" class="form-label">Lista de Contatos</label>
  ...
  <label for="type" class="form-label">Tipo de Mensagem</label>
                    <select name="type" id="type" class="js-states form-control" tabindex="-1" required>
                      <option value=""   selected >Selecione um</option>
                        ...
                        <option value="button">Mensagem com Botões</option>
                               ...
                               {{-- button start --}}
                                <div class="row">
                                    <div class="col-md-12 mt-5">
                                        <button id="startBlast" type="submit" class="btn btn-success">Iniciar</button>
                                    </div>
                                </div>
