...
@endif
                ...
                <div class="card-header d-flex justify-content-between">
                    <form action="{{route('deleteAll')}}" method="POST">
                        ...
                        <button type="submit" name="deleteAll" class="btn btn-danger "><i class="material-icons-outlined">contacts</i>Deletar todos</button>
                   </form>
                   {{--   <button type="button" class="btn btn-primary " data-bs-toggle="modal" data-bs-target="#selectNomor"><i class="material-icons-outlined">contacts</i>Gerar Contatos</button> --}}
                ...
                <div class="row">
                    <div class="col">
                        <div class="card">
                            <div class="card-header d-flex justify-content-between">
                                <h5 class="card-title">Lista de contatos de <span class="badge badge-primary">{{$tag->name}}</span></h5>
                                       ...
                                       <tr>
                                           ...
                                           <td>
                                               <div class="d-flex justify-content-center">
                                                   {{-- <button class="btn btn-success btn-sm mx-3">Add à tag</button> --}}
