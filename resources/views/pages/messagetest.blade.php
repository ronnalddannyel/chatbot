                    ...
                    <div class="col">
                        <div class="page-description page-description-tabbed">
                            ...
                            <ul class="nav nav-tabs mb-3" id="myTab" role="tablist">
                                ...
                                <li class="nav-item" role="presentation">
                                    <button class="nav-link" id="security-tab" data-bs-toggle="tab" data-bs-target="#image" type="button" role="tab" aria-controls="security" aria-selected="false">Mídia</button>
                                </li>
                                <li class="nav-item" role="presentation">
                                    <button class="nav-link" id="integrations-tab" data-bs-toggle="tab" data-bs-target="#button" type="button" role="tab" aria-controls="integrations" aria-selected="false">Botão</button>
                                </li>
                                <li class="nav-item" role="presentation">
                                        ...
                                        <div class="row">
                                            <div class="col-md-12">
                                                <div class="alert alert-danger" role="alert">
                                                    <strong>Por favor, selecione o número Whatsapp primeiro.</strong>
                                                </div>
                                            </div>
                                        </div>
                                        @else 
                                       <h5>Mensagem de Texto</h5>
                                       <div class="example-container">
                                        <div class="example-content">
                                            <form action="{{route('textMessageTest')}}" method="POST" id="formSendMsg">
                                                @csrf
                                                <label for="textmessage" class="form-label">Enviar</label>
                                                <input type="text" value={{Session::get('selectedDevice')}} name="sender" id="sender" class="form-control" readonly>
                                                   
                                                <label for="number" class="form-label">Número (receptor)</label>
                                                <input type="text" name="number" class="form-control" id="number" required>
                                                <label for="textmessage" class="form-label">Mensagem</label>
...
<div class="file-uploader">
    <label class="form-label mt-4">URL de mídia *Selecione no gerenciador de arquivos ou preencha manualmente</label><br>
                                       <span class="text-danger text-sm">certifique-se de que o URL vá diretamente para a mídia.</span>
...
<div class="form-group mt-4">
    ...
    <div class="d-flex ">
        ...
        <div class="custom-control custom-radio custom-control-inline">
            ...
            <label class="custom-control-label" for="customRadioInline1">Imagem (jpg,jpeg,png,pdf)</label>
        </div>
        <div class="custom-control custom-radio custom-control-inline">
            <input type="radio" id="customRadioInline2" name="type" class="custom-control-input" value="video">
            <label class="custom-control-label" for="customRadioInline2">Vídeo</label>
        </div>
        <div class="custom-control custom-radio custom-control-inline">
            <input type="radio" id="customRadioInline3" name="type" class="custom-control-input" value="audio">
            <label class="custom-control-label" for="customRadioInline3">Áudio</label>
        </div>
        ...
        <div class="custom-control custom-radio custom-control-inline">
            ...
            <label class="custom-control-label" for="customRadioInline9">zip</label>
                                                ...
                                                <label for="textmessage" class="form-label mt-4">Texto</label>
                                                <input type="text" name="message" class="form-control" id="textmessage" required>
                                                <button type="submit" name="sendMsg" class="btn btn-success mt-3"><i class="material-icons-outlined">send</i>Enviar</button>
                                            </form>
                                        </div>
                                         ...
                                         <div class="example-content">
                                             <form action="{{route('buttonMessageTest')}}" method="POST" id="formSendMsg">
                                                ...
                                                <input type="text" value={{Session::get('selectedDevice')}} name="sender" id="sender" class="form-control" readonly>
                                                 ...
                                                 <label for="textmessage" class="form-label">Mensagem</label>
                                                 <input type="text" name="message" class="form-control" id="textmessage" required>
                                                 <label for="footer" class="form-label">Mensagem de rodapé *opcional</label>

                                                 <input type="text" name="footer" class="form-control" id="footer" >
<div class=" file-uploader">
    <label class="form-label mt-4">Imagem *opcional</label><br>
                                      
   <div class="chose-area"></div>
</div>
                                                <button class="btn btn-sm btn-primary mt-4" type="button" id="addbutton">+ Botão</button>
                                                 <div id="button-area">
...
<div class=" file-uploader">
   ...
   <div class="chose-area"></div>
                ...
                <span class="text-danger">exemplo botão com link : <span class="badge badge-secondary">url|Visite-me|https://chatauto.com.br</span> <br> exemplo me ligue com botão : <span class="badge badge-secondary">call|Me ligue|558881889548</span>  <br> O tipo só tem duas opções, call e url!</span>
<br>
                                                 <button type="submit" name="sendMsg" class="btn btn-success mt-3"><i class="material-icons-outlined">send</i>Enviar</button>
                                             </form>
                                         </div>
                                         ...
                                         <div class="example-content">
                                             <form action="{{route('listMessageTest')}}" method="POST" id="formSendMsg">
                                                ...
                                                <input type="text" value={{Session::get('selectedDevice')}} name="sender" id="sender" class="form-control" readonly>
                                                 ...
                                                 <label for="footer" class="form-label">Título da lista</label>
                                                 <input type="text" name="title" class="form-control" id="title" required>
                                                 <label for="buttontext" class="form-label">Texto do botão </label>
