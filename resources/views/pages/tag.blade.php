...
@endif
                ...
                <div class="card-header d-flex justify-content-between">
                      ...
                      <button type="button" class="btn btn-primary " data-bs-toggle="modal" data-bs-target="#selectNomor"><i class="material-icons-outlined">contacts</i>Buscar de Grupos WA</button> 
                            ...
                            <div class="card-header d-flex justify-content-between">
                                ...
                                <div class="d-flex justify-content-right">
                                    <form action="" method="POST">
                                        <button type="submit" name="export" class="btn btn-warning "><i class="material-icons">download</i>Exportar (xlsx)</button>
                                    </form>
                                    <button type="button" class="btn btn-primary mx-2" data-bs-toggle="modal" data-bs-target="#importExcel"><i class="material-icons-outlined">upload</i>Importar (xlsx)</button>
                                       ...
                                       <tr>
                                           ...
                                           <td>
                                               <div class="d-flex justify-content-center">
                                                   <a class="btn btn-success btn-sm mx-3" href="/contact/{{$tag->id}}">Ver lista de números</a>
                                                   <form action="{{route('tag.delete')}}" method="POST" onsubmit="return confirm('do you sure want to delete this tag? ( All contacts in this tag also will delete! )')">
                                                    ...
                                                    @csrf
                                                       ...
                                                       <button type="submit" name="delete" class="btn btn-danger btn-sm"><i class="material-icons">delete_outline</i>Deletar</button>
                                                    </form>
                                               </div>
                                            </td>
                                        </tr>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLabel">Add Tag (nome da lista)</h5>
