<x-layout-dashboard title="Rest Api">
    ...
    @endif
                <h2 class="my-5">Alterar senha</h2>
                     ...
                     <div class="card">
                                    <div class="card-body">
                                        <div class="row">
                                            ...
                                            <div class="col-md-6">
                                                <form action="{{route('changeChunk')}}" method="POST">
                                                    @csrf
                                                <div class="input-group mb-3">
                                                    <span class="input-group-text" id="basic-addon1">Máximo de mensagens</span>
                                        ...
                                        <div class="row m-t-xxl">
                                            <div class="col-md-6">
                                                <label for="settingsCurrentPassword" class="form-label">Senha atual</label>
                                                <input type="password" name="current" class="form-control" aria-describedby="settingsCurrentPassword" placeholder="&#9679;&#9679;&#9679;&#9679;&#9679;&#9679;&#9679;&#9679;">
                                                <div id="settingsCurrentPassword" class="form-text">Nunca informe a sua senha para terceiros.</div>
                                            </div>
                                        </div>
                                        <div class="row m-t-xxl">
                                            <div class="col-md-6">
                                                <label for="settingsNewPassword" class="form-label">Nova senha</label>
                                                <input type="password" name="new" class="form-control" aria-describedby="settingsNewPassword" placeholder="&#9679;&#9679;&#9679;&#9679;&#9679;&#9679;&#9679;&#9679;">
                                            </div>
                                        </div>
                                        <div class="row m-t-xxl">
                                            <div class="col-md-6">
                                                <label for="settingsConfirmPassword" class="form-label">Confirmar nova senha</label>
                                        ...
                                        <div class="row m-t-lg">
                                            <div class="col">
                                                ...
                                                <button type="submit" class="btn btn-primary m-t-sm">Alterar Senha</button>
                                            </div>
                                        </div>
                                    </form>
                                    </div>
