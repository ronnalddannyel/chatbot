<x-layout-dashboard title="Scan {{$number->body}}">
    <div class="app-content">
        <div class="content-wrapper">
            <div class="container">
                <h4 class="my-5">#Whatsapp-{{$number->body}}</h4>
    
                <div class="alert alert-secondary">Não feche a câmera até ver o status CONNECTED</div>
                <div class="row">
                    <div class="col-xl-12">
                                ...
                                <div class="col-xl-4">
                                    <div class="widget-stats-large-info-container">
                                        <div class="card-header">
                                            <h5 class="card-title">Whatsapp Info<span class="badge badge-info badge-style-light">Atualizado 5 min atrás</span></h5>
                                        </div>
                                        <div class="card-body account">
    
                                            <ul class="list-group account list-group-flush">
                                                <li class="list-group-item name">Nome: </li>
                                                <li class="list-group-item number">Número: </li>
                                                <li class="list-group-item device">Whatsapp: </li>
